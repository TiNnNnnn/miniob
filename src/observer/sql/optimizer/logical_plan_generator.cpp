...
RC LogicalPlanGenerator::create_plan(SelectStmt *select_stmt, unique_ptr<LogicalOperator> &logical_operator)
{
  ...
  // inner join 1，2，3，4
  // table_get_oper: 1, table_oper:1
  // table_get_oper: 2, join_oper(1,2)     ---> table_oper: (1,2),table_get_expr:null
  // table_get_oper: 3, join_oper((1,2),3) ---> table_oper: ((1,2),3),table_get_expr:null
  // table_get_oper: 4, join_oper[4,((1,2),3)] 
...
RC LogicalPlanGenerator::create_plan(UpdateStmt *update_stmt, std::unique_ptr<LogicalOperator> &logical_operator){
    ...
    unique_ptr<LogicalOperator> update_oper(new UpdateLogicalOperator(table,value,update_stmt->attr_name()));
